...
namespace OneOddSock.IO
{
    ...
    public class BitRingBuffer
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOddSock.IO.BitRingBuffer"/> class
